...
let darktheme = ()=>{
    ...
    const icons2 = document.getElementById('car');
    const imagen = document.getElementById('nopal');
    const icons3 = document.getElementById('help');
    const icons4 = document.getElementById('exit');
    const icons5 = document.querySelectorAll('#edit');
    const icons6 = document.querySelectorAll('#delete');
    const icons7 = document.querySelectorAll('#print');
